...
public class Example3HandleSwitchUsingXpathfromInspector {
	...
	public static void main(String[] args) throws Exception {
		...
		String val=driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout[2]/android.widget.LinearLayout/android.widget.TextView[1]").getText();
