...
public class Example16CaptureVideos {
	...
	public static void main(String[] args) throws Exception {
		...
		/* below logic will try to record the video
		 * 1st: file location
		 * 2nd: file name
		 * 3rd : false: videos, true: both audio n video
		 * */
		
		ATUTestRecorder record= new ATUTestRecorder("C:\\Users\\Srujan\\eclipse-workspace\\Batch98Appium\\images","video1",false);
