...
public class Example17UISelectorCheckBox {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.findElementByAndroidUIAutomator("new UiSelector().resourceId(\"io.appium.android.apis:id/edit\")").sendKeys("Surendra Jagandam");
	...
	//	driver.findElementById("io.appium.android.apis:id/radio2").click();
		...
		driver.findElementByAndroidUIAutomator("new UiSelector().resourceId(\"io.appium.android.apis:id/radio2\")").click();
		
		//1st checkbox
		//driver.findElementById("io.appium.android.apis:id/check1").click();
		
		driver.findElementByAndroidUIAutomator("new UiSelector().resourceId(\"io.appium.android.apis:id/check1\")").click();
